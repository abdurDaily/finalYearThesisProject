        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="content-body my-5">
                    <div class="row">
                        @forelse ($yearList->getYears as $year)
                            <div class="col-lg-4 my-2">
                                <a href="{{ route('result.index',$year->id) }}" style="color:#fff;text-align:center;">
                                    <div class="subject-btn" style="padding: 30px;background:#08a83d;">
                                       <span style="font-size:18px;font-family:'Times New Roman', Times, serif;"> {{ $year->year_session  }}</span>
                                    </div>
                                </a>
                            </div>
                        @empty
