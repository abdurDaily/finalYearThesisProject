                ...
                <div class="card p-5">
                    ...
                    <div class="card-body">
                        <form action="{{ route('result.details.upload') }}" method="POST">
                            ...
                            {{-- ** DETAILS *** --}}
                            <label for="year" class="mt-5">input a year with session like spring'22</label>
                            <input type="text" name="year" class="form-control" placeholder="spring'22...write a year with sessin ">
                            {{-- **ERROR MESSAGE ** --}}
                            @if($errors->has('year'))
                             <div class="error"><strong style="color:red;font-weight:bold;">{{ $errors->first('year') }}</strong></div>
                            @endif
                            ...
                            <textarea name="resultDetails" id="resultDetails" class="form-control" cols="30" rows="10"></textarea>
                             ...
                             {{-- **ERROR MESSAGE ** --}}
                             @if($errors->has('resultDetails'))
                                <div class="error"><strong style="color:red;font-weight:bold;">{{ $errors->first('resultDetails') }}</strong></div>
                             @endif
                            ...
                            @endif
                             ...
                             {{-- SUBJECT --}}
                            <label for="subject" style="color:black;font-weight:bold;">select subject<span style="color:red;font-weight:bold;">*</span></label>
                            ...
                            @if ($errors->has('subject'))
                               <strong class="text-danger">{{ $errors->first('subject') }}</strong> <br> <br>
                            @endif
